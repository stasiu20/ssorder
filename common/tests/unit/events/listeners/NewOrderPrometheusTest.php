...
class NewOrderPrometheusTest extends Unit
{
    ...
    public function testMediate(): void
    {
        ...
        $this->assertCount(1, $collectorRegistry->getMetricFamilySamples()[1]->getSamples());
        $this->assertEquals(1, $collectorRegistry->getMetricFamilySamples()[1]->getSamples()[0]->getValue());
    }
}
